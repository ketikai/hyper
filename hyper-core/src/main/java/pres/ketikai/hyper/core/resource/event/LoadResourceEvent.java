 ...
 * @since 0.0.1
 */
public class LoadResourceEvent extends HyperResourceEvent {

    private static final HandlerList HANDLERS = new HandlerList();

    public LoadResourceEvent(File file, boolean onlyRead, boolean async) {
        super(ResourceEventType.LOAD, file, onlyRead, async);
    }
