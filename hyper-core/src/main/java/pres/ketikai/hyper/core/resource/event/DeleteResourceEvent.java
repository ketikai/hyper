 ...
 * @since 0.0.1
 */
public class DeleteResourceEvent extends HyperResourceEvent {

    private static final HandlerList HANDLERS = new HandlerList();

    public DeleteResourceEvent(File file, boolean onlyRead, boolean async) {
        super(ResourceEventType.DELETE, file, onlyRead, async);
    }
