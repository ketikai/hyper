 ...
 * @since 0.0.1
 */
public class UpdateResourceEvent extends HyperResourceEvent {

    private static final HandlerList HANDLERS = new HandlerList();

    public UpdateResourceEvent(File file, boolean onlyRead, boolean async) {
        super(ResourceEventType.UPDATE, file, onlyRead, async);
    }
